        ...
        <div className="grid-5 pr-3">
          ...
          <div >
            <ul className="list mt-3 ml-5">
              <li className="item-list py-1">Estudante de Engenharia da Computação.</li>
              <li className="item-list py-1"> Desenvolvedor Front-End na Smart Innovation.</li>
        ...
        <div className="grid-5 ">
          <div className="row hidden relative grid-photos" >
            ...
            <div className="grid-nobreak-6 grid-photo-1">
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" alt="" />
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" alt="" />
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" alt="" />
            </div>
            <div className="grid-nobreak-6 grid-photo-2" >
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" />
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" alt="" />
              <img src="https://static.poder360.com.br/2020/10/gato-animal-covid-19-450x563.jpg" className="photo my-1 px-1" alt="" />
            </div>
